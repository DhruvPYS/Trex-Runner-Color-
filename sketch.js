...
var gameOver, restart, colorGround;
...
function setup() {
  ...
  sun = createSprite(600,40,0,0)
  sun.addImage("sun", sunImage)
  sun.scale = 0.1
  trex.setCollider("circle",0,0,45)
   colorGround = createSprite(width/2,height-10,width,20)
  colorGround.shapeColor = "lime"
  ...
  score = 0;
  fill("white")
    trex.depth = colorGround.depth + 1
